...
const DetailService = lazy(() => import("./pages/services/DetailService"));
...
const routes = [
  ...
  { path: "/products-service/services", element: <Services /> },
  { path: "/products-service/services/:id", element: <DetailService /> },
